...
class MaterialCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MaterialCategory']))
		{
			$model->attributes=$_POST['MaterialCategory'];
			if($model->save())
	...
	{
		$model=new MaterialCategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MaterialCategory']))
			$model->attributes=$_GET['MaterialCategory'];
	...
	{
		$model=MaterialCategory::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='material-category-form')
		{
